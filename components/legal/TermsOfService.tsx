const TermsOfService = () => (
  <>
    ...
    <section>
      ...
      <ul>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Husk, LLC, 10067 Telluride St, Commerce City, CO 80022.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Husk, accessible from <a href="https://husk.co">https://husk.co</a>.
        </li>
        <li>
          <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
        </li>
        <li>
          <strong>Consumer</strong> means the individual accessing or using the Service for personal purposes and not for business or professional purposes.
        </li>
      </ul>
    </section>
    <section>
    ...
    <section>
      ...
      <p>
        If you have any questions about our Returns and Refunds Policy, please contact us by email: <a href="mailto:help@husk.co">help@husk.co</a>
      </p>
    </section>
  </>
);
